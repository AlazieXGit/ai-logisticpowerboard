...
import { Check, X, Zap, Crown, Star, Truck, Route, BarChart3, Sparkles } from 'lucide-react';
...
const PricingSection: React.FC = () => {
  ...
  const plans = [
    ...
    },
    {
      ...
      description: 'Best for growing businesses with TMS',
      features: [
      ...
      tmsFeatures: [
        'Full TMS Dashboard',
        'Real-time Tracking',
        'Fleet Management (up to 25 vehicles)',
    ...
    },
    {
      ...
      description: 'Complete TMS solution for large operations',
      features: [
        'Everything in Pro',
    ...
    <div className="space-y-8">
      <div className="text-center">
        ...
        <p className="text-gray-600 max-w-2xl mx-auto">
          All plans include AI-powered load matching. Basic and above include TMS capabilities.
        </p>
        <div className="mt-4 p-4 bg-blue-50 rounded-lg">
          <p className="text-sm font-medium text-blue-800">
            🤖 Updated Pricing: 2% AI Processing Fee + 2% AI Dispatching Fee
          </p>
        </div>
      </div>
        ...
        {plans.map((plan, index) => (
          ...
          >
            ...
            <CardContent className="space-y-4">
              ...
              {plan.tmsFeatures.length > 0 && (
                <div className="space-y-2">
                  <h4 className="font-semibold text-xs text-blue-700 flex items-center gap-2">
                    <Truck className="h-3 w-3" />
                    TMS:
                  </h4>
                  {plan.tmsFeatures.slice(0, 3).map((feature, idx) => (
                    <div key={idx} className="flex items-center gap-2 text-xs">
